...
' "summary": "Праздники",' +
' "description": "Праздники и памятные даты",' +
...
'}';
  ...
  jsonDest = '{"kind": "calendar#events", "etag": "\"1441859420383000\"", "summary": "Праздники", ' +
'"description": "Праздники и памятные даты", "updated": 2015-09-10T04:30:20.383Z, ' +
...
'{"kind": "calendar#event", "etag": "\"2778501856000000\"", "id": "20140108_60o30dj2c8o30c1g60o30dr4ck", "sequence": 1}]}';
...
begin
  ...
  try
    ...
    CheckEquals('Праздники', obj.Summary);
    CheckEquals('Праздники и памятные даты', obj.Description);
...
begin
  ...
  begin
    ...
    Service := TCalendarService.Create(initializer);
